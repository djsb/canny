...
bool SSDPClass::begin(){
  ...
  sprintf(_uuid, "40e30d82-7cd2-477c-b3b0-700e184e0652",
...
void SSDPClass::setMACAddress(const char *mac){
  strlcpy(_macAddress, mac, sizeof(_macAddress));
}

void SSDPClass::setDeviceKey(const char *deviceKey){
  strlcpy(_deviceKey, deviceKey, sizeof(_deviceKey));
}
